...
@section('content')
        ...
        <div class="row g-4">
            <div class="col-12 col-xxl-6">
                <div class="mb-8">
                    ...
                    <h2 class="mb-2">Ecommerce Dashboard | Trang Dashboard ở đây</h2>
                ...
                <div class="row flex-between-center mb-4 g-3">
                    ...
                    <div class="col-8 col-sm-4">
                        <form method="GET" action="{{ url('admin') }}" class="d-flex">
                            <div class="input-group">
                                <input class="form-control" type="month" id="month" name="month"
                                    value="{{ $month }}" style="max-width: 200px;">
                ...
                {{-- @dd(json_encode($dates), json_encode($earnings)) --}}
                <canvas id="earningsChart"></canvas>

                {{-- <canvas id="earningsChart" width="100%" height="400"></canvas> --}}
                    ...
                    <tbody class="list" id="table-latest-review-body">
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><a
                                    ...
                                    href="apps/e-commerce/landing/product-details.html"><img
                                        src="{{ asset('assets_ad') }}/img//products/60x60/1.png" alt=""
                                        width="53" /></a></td>
                            ...
                            <td class="align-middle review" style="min-width:350px;">
                                <p class="fs-9 fw-semibold text-body-highlight mb-0">This Fitbit is fantastic!
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><a
                                    class="d-block rounded-2 border border-translucent"
                                    href="apps/e-commerce/landing/product-details.html"><img
                                        src="{{ asset('assets_ad') }}/img//products/60x60/2.png" alt=""
                                        width="53" /></a></td>
                            <td class="align-middle product white-space-nowrap"><a class="fw-semibold"
                            ...
                            <td class="align-middle customer white-space-nowrap"><a
                                    ...
                                    <div class="avatar avatar-l"><img class="rounded-circle"
                                            src="{{ asset('assets_ad') }}/img/team/40x40/59.webp" alt="" />
                                    </div>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle customer white-space-nowrap"><a
                                    ...
                                    href="apps/e-commerce/landing/profile.html">
                                    <div class="avatar avatar-l"><img class="rounded-circle"
                                            src="{{ asset('assets_ad') }}/img/team/40x40/58.webp" alt="" />
                                    </div>
                            ...
                            <td class="align-middle review" style="min-width:350px;">
                                <p class="fs-9 fw-semibold text-body-highlight mb-0">It's a Mac, after all.
                                    Once you've gone Mac, there's no going back. My first Mac lasted over nine
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><a
                                    class="d-block rounded-2 border border-translucent"
                                    href="apps/e-commerce/landing/product-details.html"><img
                                        src="{{ asset('assets_ad') }}/img//products/60x60/4.png" alt=""
                                        width="53" /></a></td>
                            <td class="align-middle product white-space-nowrap"><a class="fw-semibold"
                            ...
                            <td class="align-middle customer white-space-nowrap"><a
                                    ...
                                    <div class="avatar avatar-l"><img class="rounded-circle avatar-placeholder"
                                            src="{{ asset('assets_ad') }}/img/team/40x40/avatar.webp" alt="" />
                                    </div>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><a
                                    class="d-block rounded-2 border border-translucent"
                                    href="apps/e-commerce/landing/product-details.html"><img
                                        src="{{ asset('assets_ad') }}/img//products/60x60/5.png" alt=""
                                        width="53" /></a></td>
                            <td class="align-middle product white-space-nowrap"><a class="fw-semibold"
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><a
                                    class="d-block rounded-2 border border-translucent"
                                    href="apps/e-commerce/landing/product-details.html"><img
                                        src="{{ asset('assets_ad') }}/img//products/60x60/6.png" alt=""
                                        width="53" /></a></td>
                            <td class="align-middle product white-space-nowrap"><a class="fw-semibold"
                            ...
                            <td class="align-middle customer white-space-nowrap"><a
                                    ...
                                    href="apps/e-commerce/landing/profile.html">
                                    <div class="avatar avatar-l"><img class="rounded-circle"
                                            src="{{ asset('assets_ad') }}/img/team/40x40/57.webp" alt="" />
                                    </div>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><a
                                    class="d-block rounded-2 border border-translucent"
                                    href="apps/e-commerce/landing/product-details.html"><img
                                        src="{{ asset('assets_ad') }}/img//products/60x60/7.png" alt=""
                                        width="53" /></a></td>
                            <td class="align-middle product white-space-nowrap"><a class="fw-semibold"
                            ...
                            <td class="align-middle customer white-space-nowrap"><a
                                    ...
                                    href="apps/e-commerce/landing/profile.html">
                                    <div class="avatar avatar-l"><img class="rounded-circle"
                                            src="{{ asset('assets_ad') }}/img/team/40x40/3.webp" alt="" />
                                    </div>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><a
                                    class="d-block rounded-2 border border-translucent"
                                    href="apps/e-commerce/landing/product-details.html"><img
                                        src="{{ asset('assets_ad') }}/img//products/60x60/8.png" alt=""
                                        width="53" /></a></td>
                            <td class="align-middle product white-space-nowrap"><a class="fw-semibold"
                            ...
                            <td class="align-middle customer white-space-nowrap"><a
                                    ...
                                    href="apps/e-commerce/landing/profile.html">
                                    <div class="avatar avatar-l"><img class="rounded-circle"
                                            src="{{ asset('assets_ad') }}/img/team/40x40/26.webp" alt="" />
                                    </div>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><a
                                    class="d-block rounded-2 border border-translucent"
                                    href="apps/e-commerce/landing/product-details.html"><img
                                        src="{{ asset('assets_ad') }}/img//products/60x60/9.png" alt=""
                                        width="53" /></a></td>
                            <td class="align-middle product white-space-nowrap"><a class="fw-semibold"
                            ...
                            <td class="align-middle customer white-space-nowrap"><a
                                    ...
                                    href="apps/e-commerce/landing/profile.html">
                                    <div class="avatar avatar-l"><img class="rounded-circle"
                                            src="{{ asset('assets_ad') }}/img/team/40x40/29.webp" alt="" />
                                    </div>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><a
                                    class="d-block rounded-2 border border-translucent"
                                    href="apps/e-commerce/landing/product-details.html"><img
                                        src="{{ asset('assets_ad') }}/img//products/60x60/10.png" alt=""
                                        width="53" /></a></td>
                            <td class="align-middle product white-space-nowrap"><a class="fw-semibold"
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><a
                                    class="d-block rounded-2 border border-translucent"
                                    href="apps/e-commerce/landing/product-details.html"><img
                                        src="{{ asset('assets_ad') }}/img//products/60x60/11.png" alt=""
                                        width="53" /></a></td>
                            <td class="align-middle product white-space-nowrap"><a class="fw-semibold"
                            ...
                            <td class="align-middle customer white-space-nowrap"><a
                                    ...
                                    href="apps/e-commerce/landing/profile.html">
                                    <div class="avatar avatar-l"><img class="rounded-circle"
                                            src="{{ asset('assets_ad') }}/img/team/40x40/8.webp" alt="" />
                                    </div>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><a
                                    class="d-block rounded-2 border border-translucent"
                                    href="apps/e-commerce/landing/product-details.html"><img
                                        src="{{ asset('assets_ad') }}/img//products/60x60/12.png" alt=""
                                        width="53" /></a></td>
                            <td class="align-middle product white-space-nowrap"><a class="fw-semibold"
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><a
                                    class="d-block rounded-2 border border-translucent"
                                    href="apps/e-commerce/landing/product-details.html"><img
                                        src="{{ asset('assets_ad') }}/img//products/60x60/13.png" alt=""
                                        width="53" /></a></td>
                            <td class="align-middle product white-space-nowrap"><a class="fw-semibold"
                            ...
                            <td class="align-middle customer white-space-nowrap"><a
                                    ...
                                    href="apps/e-commerce/landing/profile.html">
                                    <div class="avatar avatar-l"><img class="rounded-circle"
                                            src="{{ asset('assets_ad') }}/img/team/40x40/9.webp" alt="" />
                                    </div>
                            ...
                            <td class="align-middle review" style="min-width:350px;">
                                <p class="fs-9 fw-semibold text-body-highlight mb-0">I had a bit of a hard
                                    time at first but after I contacted the team they were able to help me set
                                    up the theme. It's really good and I ...<a href='#!'>See more</a></p>
                            </td>
                            <td class="align-middle text-start ps-5 status"><span
                                    class="badge badge-phoenix fs-10 badge-phoenix-warning"><span
                                        class="badge-label">Pending</span><span class="ms-1" data-feather="clock"
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><a
                                    class="d-block rounded-2 border border-translucent"
                                    href="apps/e-commerce/landing/product-details.html"><img
                                        src="{{ asset('assets_ad') }}/img//products/60x60/14.png" alt=""
                                        width="53" /></a></td>
                            <td class="align-middle product white-space-nowrap"><a class="fw-semibold"
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><a
                                    class="d-block rounded-2 border border-translucent"
                                    href="apps/e-commerce/landing/product-details.html"><img
                                        src="{{ asset('assets_ad') }}/img//products/60x60/15.png" alt=""
                                        width="53" /></a></td>
                            <td class="align-middle product white-space-nowrap"><a class="fw-semibold"
                            ...
                            <td class="align-middle customer white-space-nowrap"><a
                                    ...
                                    href="apps/e-commerce/landing/profile.html">
                                    <div class="avatar avatar-l"><img class="rounded-circle"
                                            src="{{ asset('assets_ad') }}/img/team/40x40/24.webp" alt="" />
                                    </div>
                            ...
                            <td class="align-middle review" style="min-width:350px;">
                                <p class="fs-9 fw-semibold text-body-highlight mb-0">This theme is great.
                                    Clean and easy to understand. Perfect for those who don't have time to start
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="sort border-top border-translucent text-end align-middle" scope="col"
                                    data-sort="transactions" style="width:16%">TRANSACTIONS
                                </th>
                                <th class="sort border-top border-translucent text-end align-middle" scope="col"
                                    ...
                                    <div class="d-flex align-items-center">
                                        <h6 class="mb-0 me-3">1. </h6><a href="#!">
                                            <div class="d-flex align-items-center"><img
                                                    src="{{ asset('assets_ad') }}/img/country/india.png" alt=""
                                                    width="24" />
                                ...
                                <td class="white-space-nowrap ps-0 country" style="width:32%">
                                    <div class="d-flex align-items-center">
                                        <h6 class="mb-0 me-3">2. </h6><a href="#!">
                                            <div class="d-flex align-items-center"><img
                                                    src="{{ asset('assets_ad') }}/img/country/china.png" alt=""
                                                    width="24" />
                                ...
                                <td class="white-space-nowrap ps-0 country" style="width:32%">
                                    <div class="d-flex align-items-center">
                                        <h6 class="mb-0 me-3">3. </h6><a href="#!">
                                            <div class="d-flex align-items-center"><img
                                                    src="{{ asset('assets_ad') }}/img/country/usa.png" alt=""
                                                    width="24" />
                                ...
                                <td class="white-space-nowrap ps-0 country" style="width:32%">
                                    <div class="d-flex align-items-center">
                                        <h6 class="mb-0 me-3">4. </h6><a href="#!">
                                            <div class="d-flex align-items-center"><img
                                                    src="{{ asset('assets_ad') }}/img/country/south-korea.png"
                                                    alt="" width="24" />
                                ...
                                <td class="white-space-nowrap ps-0 country" style="width:32%">
                                    <div class="d-flex align-items-center">
                                        <h6 class="mb-0 me-3">5. </h6><a href="#!">
                                            <div class="d-flex align-items-center"><img
                                                    src="{{ asset('assets_ad') }}/img/country/vietnam.png"
                                                    alt="" width="24" />
                                ...
                                <td class="white-space-nowrap ps-0 country" style="width:32%">
                                    <div class="d-flex align-items-center">
                                        <h6 class="mb-0 me-3">6. </h6><a href="#!">
                                            <div class="d-flex align-items-center"><img
                                                    src="{{ asset('assets_ad') }}/img/country/russia.png"
                                                    alt="" width="24" />
                                ...
                                <td class="white-space-nowrap ps-0 country" style="width:32%">
                                    <div class="d-flex align-items-center">
                                        <h6 class="mb-0 me-3">7. </h6><a href="#!">
                                            <div class="d-flex align-items-center"><img
                                                    src="{{ asset('assets_ad') }}/img/country/australia.png"
                                                    alt="" width="24" />
                                ...
                                <td class="white-space-nowrap ps-0 country" style="width:32%">
                                    <div class="d-flex align-items-center">
                                        <h6 class="mb-0 me-3">8. </h6><a href="#!">
                                            <div class="d-flex align-items-center"><img
                                                    src="{{ asset('assets_ad') }}/img/country/england.png"
                                                    alt="" width="24" />
                                ...
                                <td class="white-space-nowrap ps-0 country" style="width:32%">
                                    <div class="d-flex align-items-center">
                                        <h6 class="mb-0 me-3">9. </h6><a href="#!">
                                            <div class="d-flex align-items-center"><img
                                                    src="{{ asset('assets_ad') }}/img/country/indonesia.png"
                                                    alt="" width="24" />
                                ...
                                <td class="white-space-nowrap ps-0 country" style="width:32%">
                                    <div class="d-flex align-items-center">
                                        <h6 class="mb-0 me-3">10. </h6><a href="#!">
                                            <div class="d-flex align-items-center"><img
                                                    src="{{ asset('assets_ad') }}/img/country/japan.png" alt=""
                                                    width="24" />
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            console.log('Canvas context:', ctx); // Kiểm tra xem biến ctx có giá trị không
            if (ctx) {
                ...
                console.log('Chart created:', earningsChart);
            } else {
